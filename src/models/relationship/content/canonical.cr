  ...
  class Content
    class Canonical < Relationship
      validates(from_iri) do
        ...
        return "must be unique" if (instance = self.class.find?(from_iri: from_iri)) && instance.id != id
      end
      ...
      validates(to_iri) do
        ...
        return "must be unique" if (instance = self.class.find?(to_iri: to_iri)) && instance.id != id
      end
    end
  end
end
