...
class ContentRules
  ...
  Ktistec::Rule.make_pattern(NotificationQuote, Relationship::Content::Notification::Quote, associations: [:owner, :activity])
  ...
  Ktistec::Compiler.register_constant(ContentRules::NotificationQuote)
