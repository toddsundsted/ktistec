...
Spectator.describe Ameba::Rule::Ktistec::NoDirectFactoryCalls do
  ...
  it "reports direct factory method calls" do
    source = Ameba::Source.new <<-CRYSTAL, "spec/models/poll_spec.cr"
      describe "test" do
        let(poll) do
  ...
  it "allows method definitions" do
    source = Ameba::Source.new <<-CRYSTAL, "spec/spec_helper/factory.cr"
  ...
  it "skips non-spec files" do
    source = Ameba::Source.new <<-CRYSTAL, "spec/data/polls.cr"
      poll_factory(question: object)
      CRYSTAL
  ...
  it "reports non-excluded factories" do
    ...
    source = Ameba::Source.new <<-CRYSTAL, "spec/controllers/test_spec.cr"
      describe "test" do
