require "../view"
require "../../models/relationship/content/notification/announce"
...
module Rules
  abstract class View
    ...
    #
    # There is one row per announced object, holding the latest
    ...
    class Announce < View
      ...
      class_getter instance : Announce { new }
      ...
      def stored_scope(key : Key) : {String, Array(DB::Any)}
        {
          ...
          Array(DB::Any){key[:from_iri], ANNOUNCE, key[:to_iri]},
        }
      end
    end
