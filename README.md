...
### Supported Resource URI Formats

- `ktistec://users/{id}` - Registered user account information
- `ktistec://actors/{id*}` - ActivityPub actor profiles (supports batch IDs: `123,456,789`)
- `ktistec://objects/{id*}` - ActivityPub objects/posts (supports batch IDs: `123,456,789`)
- `ktistec://information` - Instance information and statistics

### Supported Collections

  - Standard: `notifications`, `timeline`, `posts`, `drafts`, `likes`, `announcements`, `followers`, `following`
